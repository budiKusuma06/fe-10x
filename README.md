...
* [`src/fe_10x/`](src/fe_10x/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/fe_10x/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `fe-10x` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/fe_10x/config.cljs) defaults to `true` in
...
```clj
(ns fe-10x.example
  (:require [fe-10x.config :as config])
